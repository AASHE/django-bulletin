...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.position'
        db.alter_column(u'bulletin_section', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Section.position'
        db.alter_column(u'bulletin_section', 'position', self.gf('django.db.models.fields.FloatField')(null=True))
