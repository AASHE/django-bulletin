...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.private'
        db.add_column(u'bulletin_category', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.private'
        db.delete_column(u'bulletin_category', 'private')
    ...
    models = {
        ...
        u'bulletin.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'include_in_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
