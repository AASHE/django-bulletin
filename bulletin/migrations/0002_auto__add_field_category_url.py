...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bulletin_category', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=640, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.url'
        db.delete_column(u'bulletin_category', 'url')
